class LibraryClass < ActiveRecord::Base
  ...
  scope :in_order, joins(:class_category).includes(:class_sub_category).reorder("class_categories.position ASC, class_sub_categories.position ASC, library_classes.position ASC")
